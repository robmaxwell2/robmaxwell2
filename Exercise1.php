...
<body>
	...
	<?php
		/**
		 * POSSIBLE SOLUTION STEP 2: Set empty variables for each form field
		 */
		$name = $email = $contBack = $comment = "";

		/**
		 * POSSIBLE SOLUTION STEP 3: Create an IF statement that sets the field values to variables when the form is submitted
		 */
